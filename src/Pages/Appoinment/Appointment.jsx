...
const Appointment = () => {
  ...
  const onSubmit = (data) => {
    if (user && user.email) {
      /* get all the data form filled by user */
      const bookingItem = {
        name: data.name,
        email: user.email,
        phone: data.phone,
      ...
      Swal.fire({
        ...
        text: 'Please login first for appointment !',
        icon: 'warning',
        ...
        if (result.isConfirmed) {
          navigate('/login', { state: { from: location } }); // send the user  to login page + apter login send user to appointment page
        }
      });
    }
  };
        ...
        <div>
          ...
          <div className='space-y-2'>
            ...
            <div className='flex items-center bg-gray-100 px-4 py-2 rounded-md'>
              ...
              <a
                href='mailto:yourname@someemail.com'
